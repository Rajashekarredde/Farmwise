        ...
        <>
            ...
            <Auth>
                <div className="bg-white border flex flex-col gap-2 p-4 pt-10">
                    <img draggable="false" className="mx-auto h-30 object-contain" src={require(`../../assests/images/logos/favicon.png`)} alt="" />
                    <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center gap-3 m-3 md:m-8">
                        <TextField
                            ...
                            required
                        />
                        <button type="submit" className="bg-forest-green font-medium py-2 rounded text-white w-full">Submit</button>
